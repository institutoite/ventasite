                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('customers.index') }}" class="btn btn-danger font-size-14">Listar</a>
                        </div>
                    </div>
                    <ul class="list-inline p-0 m-0">
                        ...
                        <li class="mb-2">
                            <div class="d-flex align-items-center">
                                ...
                                <p class="mb-0"><a href="https://api.whatsapp.com/send?phone=591{{ $customer->phone }}" target="_blank">{{ $customer->phone }}</a> </p>
                            </div>
                        </li>
