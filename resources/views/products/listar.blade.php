            ...
            <table id="productos" class="table table-bordered tabla-hover table-striped">
                ...
                <tbody>
                    @foreach ($productos as $producto)
                        <tr id="{{ $producto->id }}">
                            <td>{{ $producto->id }}</td>
                            <td><img class="crm-profile-pic avatar-100" src="{{ $producto->product_image ? storage_path('app/public/products/'.$producto->product_image) : asset('assets/images/product/default.webp') }}"></td>
