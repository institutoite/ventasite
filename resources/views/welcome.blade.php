                ...
                <div class="col-6 col-xs-6 col-sm-6 col-md-4 col-lg-3 mb-0"> 
                  <a href="{{ route("show.product.public",$product->id) }}" class="product-link"> <!-- Enlace para toda la tarjeta -->
                    <div class="product-card">
                      ...
                      <img src="{{ storage_path('app/public/products/'.$product->product_image) }}" alt="{{ $product->product_name }}">
                      <div class="card-body">
                    ...
                    var html = `
                        <div class="col-6 col-xs-6 col-sm-6 col-md-4 col-lg-3 mb-0"> 
                            <a href="{{ url("show/producto") }}/${product.id}" class="product-link">
                                <div class="product-card">
                                    <img src="{{ storage_path('app/public/products/')}}/${product.product_image}" alt="Producto ${product.id}">
                                    <div class="card-body">
