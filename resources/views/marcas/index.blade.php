    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('marcas.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus mr-3"></i>Crear Marca</a>
                <a href="{{ route('marcas.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Borrar búsqueda</a>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive rounded mb-3">
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            <td>{{ (($marcas->currentPage() * 10) - 10) + $loop->iteration  }}</td>
                            <td>{{ $marca->marca }}</td>
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
                                        href="{{ route('marcas.edit', $marca->id) }}"><i class="ri-pencil-line mr-0"></i>
                                    </a>
                                    <form action="{{ route('marcas.destroy', $marca->id) }}" method="POST" style="margin-bottom: 5px">
                                        @method('delete')
                                        @csrf
